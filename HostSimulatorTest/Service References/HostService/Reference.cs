...
namespace HostSimulatorTest.HostService {
    ...
    [System.Runtime.Serialization.DataContractAttribute(Name="AuthResult", Namespace="http://schemas.datacontract.org/2004/07/HostSimulator")]
    ...
    public partial class AuthResult : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private HostSimulatorTest.HostService.ProductItem[] ProductsListField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public HostSimulatorTest.HostService.ProductItem[] ProductsList {
            get {
    ...
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Runtime.Serialization", "4.0.0.0")]
    [System.Runtime.Serialization.DataContractAttribute(Name="ProductItem", Namespace="http://schemas.datacontract.org/2004/07/HostSimulator")]
    [System.SerializableAttribute()]
    ...
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Runtime.Serialization", "4.0.0.0")]
    [System.Runtime.Serialization.DataContractAttribute(Name="TransactionCompleteResult", Namespace="http://schemas.datacontract.org/2004/07/HostSimulator")]
    [System.SerializableAttribute()]
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="HostService.IHostService")]
    public interface IHostService {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IHostService/DoWork", ReplyAction="http://tempuri.org/IHostService/DoWorkResponse")]
        System.Threading.Tasks.Task<string> DoWorkAsync(string indata);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IHostService/GetAuth", ReplyAction="http://tempuri.org/IHostService/GetAuthResponse")]
        HostSimulatorTest.HostService.AuthResult GetAuth(string card, string stationcode);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IHostService/GetAuth", ReplyAction="http://tempuri.org/IHostService/GetAuthResponse")]
        System.Threading.Tasks.Task<HostSimulatorTest.HostService.AuthResult> GetAuthAsync(string card, string stationcode);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IHostService/TransactionComplete", ReplyAction="http://tempuri.org/IHostService/TransactionCompleteResponse")]
        HostSimulatorTest.HostService.TransactionCompleteResult TransactionComplete(string referece, double amount, double volume, int ProductCode, System.DateTime datetime);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IHostService/TransactionComplete", ReplyAction="http://tempuri.org/IHostService/TransactionCompleteResponse")]
        System.Threading.Tasks.Task<HostSimulatorTest.HostService.TransactionCompleteResult> TransactionCompleteAsync(string referece, double amount, double volume, int ProductCode, System.DateTime datetime);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IHostServiceChannel : HostSimulatorTest.HostService.IHostService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class HostServiceClient : System.ServiceModel.ClientBase<HostSimulatorTest.HostService.IHostService>, HostSimulatorTest.HostService.IHostService {
        ...
        public string DoWork(string indata) {
            return base.Channel.DoWork(indata);
        }
        
        public System.Threading.Tasks.Task<string> DoWorkAsync(string indata) {
            return base.Channel.DoWorkAsync(indata);
        }
        
        public HostSimulatorTest.HostService.AuthResult GetAuth(string card, string stationcode) {
            return base.Channel.GetAuth(card, stationcode);
        }
        
        public System.Threading.Tasks.Task<HostSimulatorTest.HostService.AuthResult> GetAuthAsync(string card, string stationcode) {
            return base.Channel.GetAuthAsync(card, stationcode);
        }
        
        public HostSimulatorTest.HostService.TransactionCompleteResult TransactionComplete(string referece, double amount, double volume, int ProductCode, System.DateTime datetime) {
            return base.Channel.TransactionComplete(referece, amount, volume, ProductCode, datetime);
        }
        
        public System.Threading.Tasks.Task<HostSimulatorTest.HostService.TransactionCompleteResult> TransactionCompleteAsync(string referece, double amount, double volume, int ProductCode, System.DateTime datetime) {
